        ...
        GoogleApiClient.OnConnectionFailedListener
{
    ...
    private static final String PLACES_API_KEY = "AIzaSyCIw4u9qCs4EBCpU1FAKjQrH_7Y4_DTyFY";
    ...
    private static final int TYPE_ATM = 6;
    ...
    private void getNewPlaces()
    {
        ...
        new AsyncTask<Void, Void, List<Place>>()
        {
            ...
            protected List<Place> doInBackground(Void... params)
            {
                ...
                try {
                    Param p = new Param("types");
                    p.value("atm");
                    Param q = new Param ("name");
                    q.value("ICICI Bank ATM");


                    places = mPlacesApi.getNearbyPlaces(mLastLocation.getLatitude(), mLastLocation.getLongitude(), MAX_RADIUS,20,p,q);
                }
                catch(Exception e) {
